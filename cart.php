...
if (isset($_POST['update_update_btn'])) {
    ...
    if ($update_value <= $product['quantity']) {
        ...
        $new_price = $update_value * $product['Price'];
        $update_quantity_query = mysqli_query($conn, "UPDATE `cart` SET quantity = '$update_value', price = '$new_price' WHERE id = '$update_id'");
...
<tbody>
    ...
    <div class="form-group">
            ...
            <div class="form-group">
                <input type="submit" class="btn btn-primary" value="Proceed to Payment" name="order_btn">
            </div>
