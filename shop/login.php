...
include "lib/connection.php";
    if (isset($_POST['submit'])) 
    {
       ...
       // echo $email;
        ...
        $loginquery="SELECT * FROM shops WHERE email='$email' AND password='$pass' and status='accepted'";
      ...
      // echo $loginres->num_rows;
        ...
        {
            echo '<script>alert("INVALID LOGIN OR ADMIN MAY NOT ACCEPTED.");</script>';
        }
    }
