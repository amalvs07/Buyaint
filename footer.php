  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-3 text-center">
        ...
        <h5 class="footer-header" style="text-align:  left" >my account</h5>
        <p style="text-align:  left" >New York, NY 10012, US<br>
        info@example.com<br>
        + 01 234 567 88<br>
        + 01 234 567 89<br>
      ...
      <div class="col-lg-4 text-center">
       ...
       <h5 class="footer-header" style="text-align:  left" >Shop</h5>

      <p style="text-align:  left" >Asian paints<br>
      Berger paints<br>
      Nerolac Paints<br>
      Indigo Paints<br>
      Nippon paints<br>
